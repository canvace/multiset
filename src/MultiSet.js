/*
 *	Canvace's utility class MultiSet
 ...
 * {{#crossLink "MultiSet"}}MultiSet{{/crossLink}}.
 * @param action.element {Any} The current element of the iteration.
 * @param action.remove {Function} A function that removes the current element.
 * @return {Boolean} `true` if `action` returned `false`, `false` if it did not
